...
public class JoinFrame extends JFrame implements ActionListener{
	...
	private void initComponents() {
		...
		// NAME field
		jTextField1.setFont(new java.awt.Font("∏º¿∫ ∞ÌµÒ", 0, 14)); // NOI18N
		...
		// PHONE NUMBER field
		jTextField2.setFont(new java.awt.Font("∏º¿∫ ∞ÌµÒ", 0, 14)); // NOI18N
		...
		// EMAIL field
		jTextField3.setFont(new java.awt.Font("∏º¿∫ ∞ÌµÒ", 0, 14)); // NOI18N
		...
		// ID field
		jTextField4.setFont(new java.awt.Font("∏º¿∫ ∞ÌµÒ", 0, 14)); // NOI18N
		...
		// PASSWORD field
		jTextField5.setFont(new java.awt.Font("∏º¿∫ ∞ÌµÒ", 0, 14)); // NOI18N
		...
		if (arg0.getSource() == joinButton) { // join button action
			try {
				if (ZinCyan.isUser(jTextField4.getText())) {
					// ¡ﬂ∫π¿Ã ¿÷¿Ω
					JOptionPane.showMessageDialog(null, "¡ﬂ∫π æ∆¿Ãµ¿‘¥œ¥Ÿ", "ERROR_MESSAGE", JOptionPane.ERROR_MESSAGE);
				} else { // ¡ﬂ∫π¿Ã æ∆¥œ∏È æ˜µ•¿Ã∆Æ
					try {
						User user = new User();
