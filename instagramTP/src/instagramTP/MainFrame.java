...
public class MainFrame extends JFrame implements java.awt.event.ActionListener{
    ...
    Image upload; Image upload_f; Image upload_h;
    Image home; Image home_f; Image home_h;
    Image search; Image search_f; Image search_h;
    Image star; Image star_f; Image star_h;
    Image mypage; Image mypage_f; Image mypage_h;
    
    ImageIcon uploadI; ImageIcon uploadI_f; ImageIcon uploadI_h;
    ImageIcon homeI; ImageIcon homeI_f; ImageIcon homeI_h;
    ImageIcon searchI; ImageIcon searchI_f; ImageIcon searchI_h;
    ImageIcon starI; ImageIcon starI_f; ImageIcon starI_h;
    ImageIcon mypageI; ImageIcon mypageI_f; ImageIcon mypageI_h;
